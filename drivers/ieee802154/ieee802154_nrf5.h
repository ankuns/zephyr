 ...
 * @ref z_ieee802154_nrf5_extra_cca_attempts_get.
 *
 * @param dev    Pointer to a ieee802154_nrf5 device
 * @param value  Value to set. Allowed range is 0...254.
 */
void z_ieee802154_nrf5_extra_cca_attempts_set(const struct device *dev, uint8_t value);

/**
 * @brief Gets the maximum number of extra CCA attempts to be performed by a transmit operation.
 *
 * @sa @ref z_ieee802154_nrf5_extra_cca_attempts_set
 *
 * @param dev    Pointer to a ieee802154_nrf5 device
 * @return       Maximum number of extra CCA attempts.
 */
uint8_t z_ieee802154_nrf5_extra_cca_attempts_get(const struct device *dev);
